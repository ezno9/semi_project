...
CREATE TABLE GUIDE_B(
	...
	SSDAMOUNT NUMBER NOT NULL,
	COOLNUM NUMBER,
	POWERNUM NUMBER NOT NULL, 
	CASENUM NUMBER NOT NULL,
	TOTALPRICE NUMBER NOT NULL,
	CATPIC VARCHAR2(500) NOT NULL,
...
CREATE TABLE MEMBER_B(
 ...
 CREATE TABLE FAVPC_B(
	...
	CPUNAME VARCHAR2(2000) NOT NULL,
	CPUPRICE NUMBER NOT NULL,
	MBNAME VARCHAR2(2000) NOT NULL,
	MBPRICE NUMBER NOT NULL, 
	RAMNAME VARCHAR2(2000) NOT NULL,
	RAMPRICE NUMBER NOT NULL,
	RAMAMOUNT NUMBER NOT NULL,
	GRAPHICNAME VARCHAR2(2000), 
	GRAPHICPRICE NUMBER, 
	SSDNAME VARCHAR2(2000) NOT NULL,
	SSDPRICE NUMBER NOT NULL,
	SSDAMOUNT NUMBER NOT NULL,
	COOLNAME VARCHAR2(2000),
	COOLPRICE NUMBER,
	POWERNAME VARCHAR2(2000) NOT NULL,
	POWERPRICE NUMBER NOT NULL, 
	CASENAME VARCHAR2(2000) NOT NULL,
	CASEPRICE NUMBER NOT NULL,
	TOTALPRICE NUMBER NOT NULL,
...
CREATE TABLE MAP_B(
	...
	C_WEBPAGE VARCHAR2(3000) NOT NULL,
	C_ADDR VARCHAR2(3000) NOT NULL,
	C_MAPADDR VARCHAR2(3000) NOT NULL
);
...
--- 메모리 스펠링 틀려서 다시 넣어주기----
INSERT INTO RAM_B VALUES(RAM_SQ.NEXTVAL,'삼성전자 DDR4 4G PC4-21300',16700,1,'MEMORY-1.jpg');
INSERT INTO RAM_B VALUES(RAM_SQ.NEXTVAL,'삼성전자 DDR4 8G PC4-21300',31000,1,'MEMORY-1.jpg');
...
INSERT INTO GUIDE_B VALUES('low1',1,1,2,1,null,1,1,null,1,1,329000,'low1.png');
INSERT INTO GUIDE_B VALUES('low2',2,2,1,2,null,2,1,null,2,2,358400,'low2.png');
INSERT INTO GUIDE_B VALUES('low3',3,4,1,2,1,3,1,null,2,3,637400,'low3.png');
INSERT INTO GUIDE_B VALUES('mid1',4,4,2,2,2,4,1,1,3,4,948000,'mid1.png');
INSERT INTO GUIDE_B VALUES('mid2',5,5,2,2,3,5,1,2,4,5,1219000,'mid2.png');
INSERT INTO GUIDE_B VALUES('mid3',6,6,3,2,4,4,1,3,5,6,1615000,'mid3.png');
INSERT INTO GUIDE_B VALUES('high1',7,7,4,2,5,6,1,4,6,7,2287000,'high1.png');
INSERT INTO GUIDE_B VALUES('high2',8,8,5,2,6,7,1,4,7,8,3014000,'high2.png');
INSERT INTO GUIDE_B VALUES('high3',9,9,6,2,6,8,1,5,8,9,3525000,'high3.png');
INSERT INTO GUIDE_B VALUES('high4',10,10,7,4,7,9,1,6,9,10,5772000,'high4.png');

--- 맵에 넣을 데이터 추가 ---
INSERT INTO MAP_B VALUES(MAP_SQ.NEXTVAL,'컴퓨존','http://www.compuzone.co.kr/main/main.htm','서울특별시 용산구 원효로 58길 1 (원효로2가 36)','서울특별시 용산구 원효로 58길 1');
INSERT INTO MAP_B VALUES(MAP_SQ.NEXTVAL,'컴스 클럽','https://comsclub.com/','서울특별시 용산구 청파로20길 9, 4001,4002,4006호(한강로2가, 용산아이피아대주피오레)','서울특별시 용산구 청파로20길 9');
INSERT INTO MAP_B VALUES(MAP_SQ.NEXTVAL,'PC_LIFE','https://www.pclife1890.co.kr/','서울특별시 용산구 청파로20길 34 ,21동 3069호(한강로2가,선인상가)','서울특별시 용산구 청파로20길 34');
INSERT INTO MAP_B VALUES(MAP_SQ.NEXTVAL,'CACHE','http://www.c-pc.kr/','인천시 서구 원당동 825-15 아침애 오피스텔 B동 204호','인천 서구 원당동 825-15');
INSERT INTO MAP_B VALUES(MAP_SQ.NEXTVAL,'컴우리','https://smartstore.naver.com/comwoori7','서울특별시 용산구 새창로 181 (선인상가) 21동 2층 4-1호','서울 용산구 새창로 181');
...
AS SELECT GB.GUIDE GUIDE, CP.NAME CPU, CP.PRICE CPU_PRICE, CP.PIC CPU_PIC,
		...
		SD.NAME SSD, SD.PRICE SSD_PRICE, SD.PIC SSD_PIC, GB.SSDAMOUNT SSD_AMOUNT,
		CL.NAME COOLER, CL.PRICE COOLER_PRICE, CL.PIC COOLER_PIC,
		PW.NAME POWER, PW.PRICE POWER_PRICE, PW.PIC POWER_PIC,
		CS.NAME CASE, CS.PRICE CASE_PRICE, CS.PIC CASE_PIC,GB.CATPIC CATPIC
FROM GUIDE_B GB
